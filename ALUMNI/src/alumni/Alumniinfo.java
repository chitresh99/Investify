 ...
 * @author Abhijit
 */
public class Alumniinfo extends javax.swing.JFrame {
...
try {
    ...
    // Assuming the "id" is the primary key for the alumniinfo table
    String updateQuery = "UPDATE alumniinfo SET name = ?, dob = ?, age = ?, gender = ?, email = ?, mobile = ?, pass = ?, degree = ?, skills = ?, linkdin = ?, master = ?, mdegree = ? WHERE id = ?";
    ...
    ps.setString(5, email2);
    ps.setString(6, mobile2);
    ps.setString(7, year2);
    ps.setString(8, degree2);
    ps.setString(9, skills2);
    ps.setString(10, linkdin2);
    ps.setString(11, master2);
    ps.setString(12, mdegree2);
    ps.setString(13, id);
    ...
    if (rowsAffected > 0) {
        ...
        JOptionPane.showMessageDialog(this, "No records updated. Make sure the ID exists.");
    }
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        // TODO add your handling code here:
      String search = JOptionPane.showInputDialog(this, "Enter alumniinfo id to search");
try {
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db", "root", "Mane2004@");

    PreparedStatement ps = con.prepareStatement("SELECT * from alumniinfo where ID=?");
    ps.setString(1, search);

    ResultSet rs = ps.executeQuery(); // Declare the ResultSet here

    if (rs.next()) {
        moodle.setText(rs.getString("id"));
        ...
        year.setText(rs.getString("pass"));
         degree.setText(rs.getString("degree"));
          skills.setText(rs.getString("skills"));
           linkdin.setText(rs.getString("linkdin"));
            master.setText(rs.getString("master"));
            mdegree.setText(rs.getString("mdegree"));
    } else {
        // Handle the case where no matching record was found
        JOptionPane.showMessageDialog(this, "Alumni not found");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Alumniinfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Alumniinfo().setVisible(true);
            }
        });
    }
