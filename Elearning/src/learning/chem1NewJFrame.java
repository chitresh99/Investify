 ...
 * @author kdmsa
 */
public class chem1NewJFrame extends javax.swing.JFrame {

    /**
     * Creates new form chem1NewJFrame
     */
    public chem1NewJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ENGINEERING CHEMISTRY-1");

        jLabel8.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(153, 153, 0));
        jLabel8.setText("MODULE NO.1 ATOMIC AND MOLECULAR STRUCTURE.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
              // TODO add your handling code here:
              try{
            Desktop.getDesktop().browse (new URL("https://www.youtube.com/watch?v=NMN1zm_X9bk&list=PLT3bOBUU3L9gan-gjVkz6f9hZJYpHapHi&index=1&pp=iAQB").toURI());
        }
        catch(Exception e)
        {} 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chem1NewJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chem1NewJFrame().setVisible(true);
            }
        });
    }
