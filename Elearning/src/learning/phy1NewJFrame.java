 ...
 * @author kdmsa
 */
public class phy1NewJFrame extends javax.swing.JFrame {

    /**
     * Creates new form phy1NewJFrame
     */
    public phy1NewJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ENGINEERING PHYSICS-1");

        jLabel8.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 102, 153));
        jLabel8.setText("MODULE NO.1 QUANTUM PHYSICS.");
        ...
        jLabel7.getAccessibleContext().setAccessibleName("ENGINEERING PHYSICS-1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
               // TODO add your handling code here:
                try{
            Desktop.getDesktop().browse (new URL("https://www.youtube.com/watch?v=OqHv8gy3g7s&list=RDCMUCDYDsnf5-sljDu8s4GEvJPw&start_radio=1&rv=OqHv8gy3g7s").toURI());
        }
        catch(Exception e)
        {} 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(phy1NewJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new phy1NewJFrame().setVisible(true);
            }
        });
    }
