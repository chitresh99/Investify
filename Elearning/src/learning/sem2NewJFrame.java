 ...
 * @author kdmsa
 */
public class sem2NewJFrame extends javax.swing.JFrame {

    /**
     * Creates new form sem2NewJFrame
     */
    public sem2NewJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ENGINEERING Graphics");

        jLabel8.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 51, 0));
        jLabel8.setText("MODULE NO.1 INTRODUCTION TO ENGINEERING GRAPHICS.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                // TODO add your handling code here:
                 try{
            Desktop.getDesktop().browse (new URL("https://www.youtube.com/watch?v=uojN7SOHPBw&list=PL9RcWoqXmzaJT-fliqTSwUjWU4zCX_H2A").toURI());
        }
        catch(Exception e)
        {}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sem2NewJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sem2NewJFrame().setVisible(true);
            }
        });
    }
