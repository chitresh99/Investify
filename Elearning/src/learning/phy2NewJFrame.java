 ...
 * @author kdmsa
 */
public class phy2NewJFrame extends javax.swing.JFrame {

    /**
     * Creates new form phy2NewJFrame
     */
    public phy2NewJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ENGINEERING PHYSICS-2");

        jLabel8.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 102, 153));
        jLabel8.setText("MODULE NO.1 INTERFERNCE AND DIFFERACTION OF LIGHT.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                // TODO add your handling code here:
                  try{
            Desktop.getDesktop().browse (new URL("https://www.youtube.com/watch?v=IxzoUqq7ZcQ&list=PL0s3O6GgLL5fJQqXcIdBFY0cvT3LbTPOZ").toURI());
        }
        catch(Exception e)
        {} 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(phy2NewJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new phy2NewJFrame().setVisible(true);
            }
        });
    }
