 ...
 * @author kdmsa
 */
public class mechNewJFrame extends javax.swing.JFrame {

    /**
     * Creates new form mechNewJFrame
     */
    public mechNewJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("MODULE NO.1 SYSTEM OF A COPLANAR FORCES.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                // TODO add your handling code here:
                try{
            Desktop.getDesktop().browse (new URL("https://www.youtube.com/watch?v=x2CukrtOnTY&pp=ygUvc3lzdGVtIG9mIGNvcGxhbmFyIGZvcmNlcyBlbmdpbmVlcmluZyBtZWNoYW5pY3M%3D").toURI());
        }
        catch(Exception e)
        {} 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mechNewJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mechNewJFrame().setVisible(true);
            }
        });
    }
