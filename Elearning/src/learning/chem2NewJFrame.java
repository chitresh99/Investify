 ...
 * @author kdmsa
 */
public class chem2NewJFrame extends javax.swing.JFrame {

    /**
     * Creates new form chem2NewJFrame
     */
    public chem2NewJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ENGINEERING CHEMISTRY-2");

        jLabel8.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(153, 153, 0));
        jLabel8.setText("MODULE NO.1 CORROSION.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
               // TODO add your handling code here:
                try{
            Desktop.getDesktop().browse (new URL("https://www.youtube.com/watch?v=d63DiqQ9zUM&list=PL0s3O6GgLL5e0zxcjYr9yu3K4Hn1GlxV_").toURI());
        }
        catch(Exception e)
        {}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chem2NewJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chem2NewJFrame().setVisible(true);
            }
        });
    }
