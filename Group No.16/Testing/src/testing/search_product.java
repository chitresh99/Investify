...
public class search_product extends javax.swing.JFrame {
    ...
    public class func{                                                   // creating a function                                     
        public ResultSet find(String s) throws SQLException{            //Creating a method of resulset to find photo from database with the help of input taken
            try {
    ...
    int TotalPricei1,TotalPricei2,TotalPricei3,TotalPricei4,TotalPricei5,TotalPricei6,TotalPricei7,TotalPricei8,TotalPricei9,TotalPricei10,TotalPricei11;
    String TotalPrices1,TotalPrices2,TotalPrices3,TotalPrices4,TotalPrices5,TotalPrices6,TotalPrices7,TotalPrices8,TotalPrices9,TotalPrices10,TotalPrices11;
    public void Vegetable() throws SQLException{    //function to display latest vegetables product
        try {
    ...
    public void Fruits() throws SQLException{                  //functions to display latest fruits product added
        try {
            String SUrl,SUser,SPass,Quantity,Price_per_unit,Product_description,Product_name,Price1,Price2,Quantity2,Quantity1;
            Product_name = "Product Name :";
            Quantity = "Quantity :";
            ...
            unit4.setText(rs.getString("unit"));
            Price2 = rs.getString("price_per_unit");
            price4.setText(Price2);
    ...
    public void SeedPowder() throws SQLException{                //function to display latest seedpowder products added
        try {
            String SUrl,SUser,SPass,Quantity,Price_per_unit,Product_description,Product_name,Price1,Price2,Quantity2,Quantity1;
            Product_name = "Product Name :";
            Quantity = "Quantity :";
    ...
    public void Pesticide() throws SQLException{                               //function to display latest pesticide added
        try {
            String SUrl,SUser,SPass,Quantity,Price_per_unit,Product_description,Product_name,Price1,Price2,Quantity2,Quantity1;
            Product_name = "Product Name :";
            Quantity = "Quantity :";
            ...
            Quantity1 = rs.getString("quatity");
            number7.setText(Quantity1);
            unit7.setText(rs.getString("unit"));
            Price1 = rs.getString("price_per_unit");
            price7.setText(Price1);
            ...
            Quantity2 = rs.getString("quatity");
            number8.setText(Quantity2);
            unit8.setText(rs.getString("unit"));
            Price2 = rs.getString("price_per_unit");
            price8.setText(Price2);
            ...
            int p2 = Integer.parseInt(Price2);
            TotalPricei8 = q2*p2;
            TotalPrices8 = String.valueOf(TotalPricei8);
    ...
    public void Fertilizer() throws SQLException{        //function to display latest fertilizer added
        try {
            String SUrl,SUser,SPass,Quantity,Price_per_unit,Product_description,Product_name,Price1,Price2,Quantity2,Quantity1;
            Product_name = "Product Name :";
            Quantity = "Quantity :";
            ...
            Quantity1 = rs.getString("quatity");
            number9.setText(Quantity1);
            unit9.setText(rs.getString("unit"));
            Price1 = rs.getString("price_per_unit");
            price9.setText(Price1 );
            ...
            int p1 = Integer.parseInt(Price1);
            TotalPricei9 = q1*p1;
            TotalPrices9 = String.valueOf(TotalPricei9);
            ...
            Quantity2 = rs.getString("quatity");
            number10.setText(Quantity2);
            unit10.setText(rs.getString("unit"));
            Price2 = rs.getString("price_per_unit");
            price10.setText( Price2);
            ...
            int p2 = Integer.parseInt(Price2);
            TotalPricei10 = q2*p2;
            TotalPrices10 = String.valueOf(TotalPricei10);
    ...
    private void initComponents() {
        ...
        tab5 = new scrollbar.ScrollPaneWin11();
        ...
        jScrollPane14 = new scrollbar.ScrollPaneWin11();
        ...
        jScrollPane15 = new scrollbar.ScrollPaneWin11();
        ...
        buy7 = new javax.swing.JLabel();
        buy8 = new javax.swing.JLabel();
        tab6 = new scrollbar.ScrollPaneWin11();
        ...
        jScrollPane16 = new scrollbar.ScrollPaneWin11();
        ...
        jScrollPane17 = new scrollbar.ScrollPaneWin11();
        ...
        buy9 = new javax.swing.JLabel();
        buy10 = new javax.swing.JLabel();
        ...
        fertilizerbtn1.setForeground(new java.awt.Color(0, 204, 255));
        ...
        kGradientPanel1.add(fertilizerbtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 120, -1, -1));

        fertilizerbtn2.setFont(new java.awt.Font("The Bold Font", 1, 24)); // NOI18N
        fertilizerbtn2.setForeground(new java.awt.Color(0, 204, 255));
        ...
        kGradientPanel1.add(fertilizerbtn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 120, -1, -1));
        ...
        kGradientPanel1.add(pestbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 120, -1, -1));
        ...
        kGradientPanel1.add(seedsbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 120, -1, -1));
        ...
        kGradientPanel1.add(fruitsbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 110, -1, 40));
        ...
        kGradientPanel1.add(vegetablebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, -1, 40));
        ...
        kGradientPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, -1, 40));
        ...
        jPanel4.add(display_product, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 250, 250));
        ...
        jPanel4.add(product, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 50, 240, 40));
        ...
        jPanel4.add(number, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 100, 50, 40));
        ...
        jPanel4.add(price, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 160, 40, 40));
        ...
        jPanel4.add(price_unit, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 160, 40, 40));
        ...
        jPanel4.add(unit, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 100, 50, 40));
        ...
        jPanel4.add(prodescrip, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 210, 220, 40));
        ...
        jPanel4.add(qunatity, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 100, 120, 40));
        ...
        jPanel4.add(priceunit, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 160, 40));
        ...
        jPanel4.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, 310, 190));
        ...
        jPanel4.add(buy, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 130, 110, 70));
        ...
        jPanel3.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 280, 400, 180));
        ...
        jPanel3.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 800, 410, 180));
        ...
        jPanel3.add(buy1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 130, 90, 60));
        ...
        jPanel3.add(buy2, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 650, 100, 60));
        ...
        jPanel5.add(jScrollPane10, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 290, 400, 220));
        ...
        jPanel5.add(jScrollPane11, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 780, 390, 220));
        ...
        jPanel5.add(buy3, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 150, 100, 60));
        ...
        jPanel5.add(buy4, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 640, 100, 60));
        ...
        jPanel7.add(jScrollPane12, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 280, 410, 190));
        ...
        jPanel7.add(jScrollPane13, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 740, 420, 200));
        ...
        jPanel7.add(buy6, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 600, 110, 60));
        ...
        jPanel8.add(jScrollPane14, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 280, 470, 190));
        ...
        description8.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel8.add(jScrollPane15, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 740, 480, 210));
        ...
        buy7.setFont(new java.awt.Font("The Bold Font", 0, 48)); // NOI18N
        buy7.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buy7MouseClicked(evt);
            }
        });
        jPanel8.add(buy7, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 150, 90, 60));

        buy8.setFont(new java.awt.Font("The Bold Font", 0, 48)); // NOI18N
        buy8.setForeground(new java.awt.Color(0, 0, 0));
        buy8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        buy8.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buy8MouseClicked(evt);
            }
        });
        jPanel8.add(buy8, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 600, 110, 60));
        ...
        jPanel9.add(jScrollPane16, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 280, 580, 200));
        ...
        jPanel9.add(jScrollPane17, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 740, 570, 210));
        ...
        buy9.setFont(new java.awt.Font("The Bold Font", 0, 48)); // NOI18N
        buy9.setForeground(new java.awt.Color(0, 0, 0));
        buy9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        buy9.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buy9MouseClicked(evt);
            }
        });
        jPanel9.add(buy9, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 140, 90, 60));

        buy10.setFont(new java.awt.Font("The Bold Font", 0, 48)); // NOI18N
        buy10.setForeground(new java.awt.Color(0, 0, 0));
        buy10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        buy10.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buy10MouseClicked(evt);
            }
        });
        jPanel9.add(buy10, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 600, 90, 60));
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        // TODO add your handling code here:
        DashboardFarmer DB = new DashboardFarmer();
        DB.show();
        dispose();
    ...
    private void search_proActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_proActionPerformed
        ...
        try {
            ...
            rs = f.find(search.getText());     //searches for input given through textfield in database and returns a boolean value
            if(rs.next()){
                byte[] img = rs.getBytes("photo");
                ImageIcon image = new ImageIcon(img);
                Image im = image.getImage();
            ...
            int p1 = Integer.parseInt(Price1);
            TotalPricei11 = q1*p1;
            TotalPrices11 = String.valueOf(TotalPricei11);
            }else{
    ...
    private void buy7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buy7MouseClicked
        // TODO add your handling code here:
        payment_box pb = new payment_box();
        pb.productname.setText("Product Name :" + product10.getText());
        pb.quantity.setText(number7.getText());
        pb.payment_unit.setText(unit7.getText());
    ...
    private void buy8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buy8MouseClicked
        // TODO add your handling code here:
        payment_box pb = new payment_box();
        pb.productname.setText("Product Name :" + product11.getText());
        pb.quantity.setText(number8.getText());
        pb.payment_unit.setText(unit8.getText());
        pb.price.setText(TotalPrices8);
        pb.show();
        dispose();
    }//GEN-LAST:event_buy8MouseClicked

    private void buy9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buy9MouseClicked
        // TODO add your handling code here:
        payment_box pb = new payment_box();
        pb.productname.setText("Product Name :" + product12.getText());
        pb.quantity.setText(number9.getText());
        pb.payment_unit.setText(unit9.getText());
        pb.price.setText(TotalPrices9);
        pb.show();
        dispose();
    }//GEN-LAST:event_buy9MouseClicked

    private void buy10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buy10MouseClicked
        // TODO add your handling code here:
        payment_box pb = new payment_box();
        pb.productname.setText("Product Name :" + product13.getText());
        pb.quantity.setText(number10.getText());
        pb.payment_unit.setText(unit10.getText());
        pb.price.setText(TotalPrices10);
        pb.show();
        dispose();
    }//GEN-LAST:event_buy10MouseClicked
    ...
    private javax.swing.JLabel buy10;
    ...
    private javax.swing.JLabel buy7;
    private javax.swing.JLabel buy8;
    private javax.swing.JLabel buy9;
