...
public class updmem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/back-arrow s.png"))); // NOI18N
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        ...
        int checkid = 0;        // Initialize a variable to keep track of whether the ID exists in the database.
    ...
    String dob=jTextField22.getText();
...
PreparedStatement ps=con.prepareStatement ("update member set name=?, contact=?, gender=?, dob=?,amountpaid=?, expire=? where id=?");
 //set values 
        ps.setString(1,name);
